...
/**
 * Cette tache écrit dans un fichier de log propre /var/lib/RSSAgregate/log/stillalive. Ce fichier permet de vérifier qu'il n'y a pas de coupure sur le service
 * @author clem
 */
public class TacheStillAlive extends AbstrTacheSchedule<TacheStillAlive> implements Incidable{
    ...
    /***
     * Si la tache constate que le serveur n'a pas inscrit continuellement dans le fichier still alive, cette variable est a true
     */
    Boolean rupture;
    ...
    private TacheStillAlive(Observer s) {
        super(s);
        rupture = false;
    }
