 ...
 * pas récupéré sur un serveur esclaves. Cette tache est appelée par la tache
 * TacheSynchroHebdomadaire
 *
 * @author clem
 */
public class TacheSynchroRecupItem extends AbstrTacheSchedule<TacheSynchroRecupItem> implements Incidable{
    ...
    /**
     * *
     * Un pointeur veur l'executor service permettant d'executer et controler la
     * tâche
     */
    ...
    /**
     * *
     * Lance la tâche de récupération des items sur chacun des esclaves. Pour la
     * syntaxe d'envoie de requete HTT l'exemple a été pris sur:
