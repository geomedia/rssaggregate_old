 ...
 * @author clem
 */
@WebServlet(name = "testCalculQualite", urlPatterns = {"/testCalculQualite"})
public class testCalculQualite extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Flux f = (Flux) dao.find(new Long(27202));
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet testCalculQualite</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet testCalculQualite at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        } finally {            
            out.close();
